(function () {
    ...
    WC.toast = function (message, type, duration) {
        ...
        // Never spam device errors — chatting does not need a camera
        if (/requested device not found/i.test(message) ||
            /camera or microphone not found/i.test(message) ||
            /microphone\/camera permission denied/i.test(message) ||
