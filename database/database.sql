...
-- Seed app user (Leong): username=Lwh_0326  email=leongwenghong5@gmail.com  password=user123
-- Hash generated with password_hash('user123', PASSWORD_DEFAULT)
INSERT INTO `users` (`username`, `email`, `password_hash`, `status_message`, `presence`) VALUES
('Lwh_0326', 'leongwenghong5@gmail.com', '$2y$10$0HfS8HajsVxqsbr86XtN..thveU1uylUjYAeaoZLz4dw4BZsKb6N.', 'Let''s be friend!!!', 'offline');
